...
from qgis.core import Qgis, QgsCoordinateReferenceSystem, QgsProject, QgsCoordinateTransform
#from qgis.gui import QgsProj
...
class NumericalVertexEdit:
    ...
    def run(self):
        ...
        self.tool.connect(self.moveVertex)
